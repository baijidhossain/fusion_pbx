...
$sql = "
		...
		from v_xml_cdr where domain_uuid = :domain_uuid ";
...
$sql .= " and start_epoch > " . (time() - 86400) . " order by start_epoch desc";
...
if ($num_rows > 0) {
  $theme_cdr_images_exist = (file_exists($theme_image_path . "icon_cdr_inbound_answered.png") &&
